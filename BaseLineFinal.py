...
def readData(pathArray):   
    ...
    for path in pathArray:
        ...
        for row in input_file:
            ...
            sex = row['Sex']
            if row['Diagnosis'] == '52':
                labeledData.append((age, race, sex, 1))
            else:
                labeledData.append((age, race, sex, 0))
...
def extractWordFeatures(ageFeature, raceFeature, sexFeature):
    """
...
def evaluatePredictor(examples, predictor):
    ...
    for age, race, sex, y in examples:
        currVal = predictor(age, race, sex)
        xValue = 0
...
def learnPredictor(trainExamples, testExamples, featureExtractor, numIters, eta):
    ...
    for t in range(numIters):
        for currTrain in trainExamples:
            features = featureExtractor(currTrain[0], currTrain[1], currTrain[2])
            margin = dotProduct(weights, features)
            logistic = (1.0/(1+math.exp(-1*margin)))-currTrain[3]
            for feature in features:
                if feature in weights:
                    weights[feature] -= eta*features[feature]*logistic
                else:
                    weights[feature] = -eta*features[feature]*logistic
    print("Train error is:")
    print(evaluatePredictor(trainExamples, lambda x, y, z : (1.0/(1+math.exp(-1*dotProduct(featureExtractor(x, y, z), weights))))))
    print("")
    print("Test error is:")
    print(evaluatePredictor(testExamples, lambda x, y, z : (1.0/(1+math.exp(-1*dotProduct(featureExtractor(x, y, z), weights))))))
    print("")
    return weights
...
"""
trainDataPath = [
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2009.csv", 
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2010.csv",
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2011.csv", 
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2012.csv",
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2013.csv",
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2014.csv", 
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2015.csv",
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2016.csv"
]

testDataPath = [
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2017.csv",
"/Users/Alejandro/Desktop/CS_221/Project/NEISS_39042/NEISS_2018.csv"]
"""
